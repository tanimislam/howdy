...
def createRadio(clientID, userID, artist = '', track = '', mood = '', era = '',
    ...
    """
    Queries a set of radio stations on Gracenote_ to create, and returns a :py:class:`list` of :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>` dictionaries corresponding to those radio stations that have been created. This was created by the GitHub_ user Fabian_ to cover the `Gracenote Rhythm`_ API.
    ...
    :returns: a :py:class:`list` of :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>` radio stations that match the above query.
    :rtype: list
...
def search(clientID, userID, artist='', album='', track='', toc='', verify = True ):
    ...
    :returns: a :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>` of album metadata corresponding to this query.
    :rtype: :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>`
...
def get_discography(clientID, userID, artist, rangeStart = 1, rangeEnd = 10,
    ...
    :returns: a :py:class:`list` of all albums found for ``artist``. Each album is stored as :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>`.
    :rtype: :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>`
    """
...
def fetch(clientID, userID, GNID, verify = True ):
    ...
    :returns: a :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>` containing the metadata for the album.
    :rtype: :py:class:`gnmetadata <plexstuff.music.pygn.gnmetadata>`
    """
