...
def send_individual_email_full_withattachs(
    ...
    """
    Sends the HTML email, with optional attachments, to a single recipient email address. This uses the :py:class:`SMTP <smtplib.SMTP>` Python functionality to send through a local SMTP_ server (see :py:meth:`send_email_localsmtp <plexstuff.plexemail.send_email_localsmtp>`).
