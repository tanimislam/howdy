...
class TMDBEngine( object ):
    ...
    def __new__( cls, verify = True ):
        """
        Instantiates a single object of type :py:class:`TMDBEngine.__TMDBEngine <howdy.movie.TMDBEngine.__TMDBEngine>` that contains TMDB_ API genre ID mappings, and that updates the GUI database to load all TTF fonts in the ``resources`` subdirectory.

        :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
        :returns: a single instance of :py:class:`TMDBEngine.__TMDBEngine <howdy.movie.TMDBEngine.__TMDBEngine>`.
        :rtype: :py:class:`TMDBEngine.__TMDBEngine <howdy.movie.TMDBEngine.__TMDBEngine>`
        """
...
class TMDBEngineSimple( object ):
    ...
    def __new__( cls, verify = True ):
        """
        Instantiates a single object of type :py:class:`TMDBEngineSimple.__TMDBEngine <howdy.movie.TMDBEngineSimple.__TMDBEngine>` that contains TMDB_ API genre ID mappings.

        :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
        :returns: a single instance of :py:class:`TMDBEngineSimple.__TMDBEngine <howdy.movie.TMDBEngineSimple.__TMDBEngine>`.
        :rtype: :py:class:`TMDBEngineSimple.__TMDBEngine <howdy.movie.TMDBEngineSimple.__TMDBEngine>`
        """
