...
from howdy.core import session, core
from howdy.core import get_formatted_size, get_formatted_duration
from howdy.email import send_email_lowlevel, send_email_localsmtp, emailAddress, emailName
...
def get_summary_data_thisamericanlife_remote( token, fullURL = 'http://localhost:32400' ):
    ...
    sinceDate = core.get_current_date_newsletter( )
    key, song_data = core._get_library_data_artist( keynum, token, fullURL = fullURL )
    num_episodes = 0
    totdur = 0.0
    totsizebytes = 0.0
