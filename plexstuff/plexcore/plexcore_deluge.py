...
from plexstuff.plexcore import session, PlexConfig, get_formatted_size
...
def create_deluge_client( url, port, username, password ):
    ...
    .. seealso:: 
      * :py:meth:`get_deluge_client <plexstuff.plexcore.plexcore_deluge.get_deluge_client>`
      * :py:meth:`get_deluge_credentials <plexstuff.plexcore.plexcore_deluge.get_deluge_credentials>`
      * :py:meth:`push_deluge_credentials <plexstuff.plexcore.plexcore_deluge.push_deluge_credentials>`
...
def get_deluge_client( ):
    ...
    .. seealso::
      * :py:meth:`create_deluge_client <plexstuff.plexcore.plexcore_deluge.create_deluge_client>`
      * :py:meth:`get_deluge_credentials <plexstuff.plexcore.plexcore_deluge.get_deluge_credentials>`
      * :py:meth:`push_deluge_credentials <plexstuff.plexcore.plexcore_deluge.push_deluge_credentials>`
    """
...
def deluge_add_torrent_file( client, torrent_file_name ):
    ...
    .. seealso:: :py:meth:`deluge_add_torrent_file_as_data <plexstuff.plexcore.plexcore_deluge.deluge_add_torrent_file_as_data>`
    """
...
def deluge_add_torrent_file_as_data( client, torrent_file_name,
    ...
    .. seealso:: :py:meth:`deluge_add_torrent_file <plexstuff.plexcore.plexcore_deluge.deluge_add_torrent_file>`
    """
...
def deluge_format_info( status, torrent_id ):
    ...
    .. seealso:: :py:meth:`deluge_get_torrents_info <plexstuff.plexcore.plexcore_deluge.deluge_get_torrents_info>`.
    """
