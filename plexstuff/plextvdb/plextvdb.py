...
from plexstuff.plextmdb import plextmdb
...
class TVShow( object ):
    ...
    :var dict seasonDict: a :py:class:`dict`, whose keys are the season numbers and whose values are the :py:class:`TVSeason <plexstuff.plextvdb.plextvdb.TVSeason>` associated with that season of the series.
    ...
    def create_tvshow_dict( cls, tvdata, token = None, verify = True,
        ...
        """
        :param dict tvdata: the Plex_ TV library information returned by :py:meth:`get_library_data <plexstuff.plexcore.plexcore.get_library_data>`.
        ...
        :returns: a :py:class:`dict`, whose keys are the TV show names and whose values are the :py:class:`TVShow <plexstuff.plextvdb.plextvdb.TVSeason>` associated with that TV show.
        :rtype: dict
        """
        time0 = time.time( )
    ...
    def get_tot_epdict_tvdb( self ):
        ...
        * The second level dictionary has keys (for each season) that are the season's episodes. Each value is a :py:class:`tuple` of episode name and air date, as a :py:class:`date <datetime.date>`.
        ...
        An example of the output format is described in the pure method :py:meth:`get_tot_epdict_tvdb <plexstuff.plextvdb.plextvdb.get_tot_epdict_tvdb>`.

        :rtype: dict

        .. seealso:: :py:meth:`get_tot_epdict_tvdb <plexstuff.plextvdb.plextvdb.get_tot_epdict_tvdb>`
        """
        tot_epdict = { }
...
class TVSeason( object ):
    ...
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
    :param list eps: optional argument. The :py:class:`list` of TV shows returned by the TVDB_ API, and whose format is described in :py:meth:`get_episodes_series <plexstuff.plextvdb.plextvdb.get_episodes_series>`.
...
def get_tvdata_ordered_by_date( tvdata ):
    """
    This *flattens* the TV data, stored as a nested :py:class:`dict` (see documentation in :py:meth:`get_library_data <plexstuff.plexcore.plexcore.get_library_data>` that focuses on the format of the dictionary for TV libraries) into a dictionary whose keys are the :py:class:`date <datetime.date>` at which episodes have been aired, and whose values are the :py:class:`list` of episodes aired on that date. Each element of that list is a :py:class:`tuple` representing a given episode: ``( SHOW, SEASON #, EPISODE #, EPISODE TITLE )``.

    For example, let ``tvdata`` represent the Plex_ TV library information  collected with :py:meth:`get_library_data <plexstuff.plexcore.plexcore.get_library_data>`. Then here are the episodes on the Plex_ server aired on the *last* date.
    ...
    .. seealso:: :py:meth:`create_plot_year_tvdata <plexstuff.plextvdb.plextvdb.create_plot_year_tvdata>`
    """
...
def get_possible_ids( series_name, tvdb_token, verify = True ):
    """
    Returns a :py:class:`tuple` of candidate TV shows from the TVDB_ database that match a series name, and status string. If matches could not be found, returns an error :py:class:`tuple` returned by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>` -- first element is ``None``, second element is :py:class:`str` error message.
    ...
    :returns: a :py:class:`tuple` of candidate TVDB_ series that match ``series_name``, and the :py:class:`str` ``'SUCCESS'``. Otherwise an error tuple returned by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`.
    :rtype: tuple
...
def get_series_info( series_id, tvdb_token, verify = True ):
    """
    Returns a :py:class:`tuple` of TVDB_ summary information AND the string "SUCCESS" for a given Tv show, otherwise returns an error :py:class:`tuple` given by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`. For example, here is the summary information returned for `The Simpsons`_.
    ...
    :returns: a :py:class:`tuple` of candidate TV show info, and the :py:class:`str` ``'SUCCESS'``. Otherwise an error tuple returned by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`.
    :rtype: tuple
    """
    headers = { 'Content-Type' : 'application/json',
                'Authorization' : 'Bearer %s' % tvdb_token }
...
def get_series_image( series_id, tvdb_token, verify = True ):
    """
    Returns a :py:class:`tuple` of the TVDB_ URL of the TV show's poster AND the string "SUCCESS", if found. Otherwise returns an error :py:class:`tuple` given by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`. For example, here is the TVDB_ poster URL for `The Simpsons`_.
    ...
    :returns: a :py:class:`tuple` of TV show poster URL, and the :py:class:`str` ``'SUCCESS'``. Otherwise an error tuple returned by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`.
    :rtype: tuple

    .. seealso:: :py:meth:`get_series_season_image <plexstuff.plextvdb.plextvdb.get_series_season_image>`
    """
    headers = { 'Content-Type' : 'application/json',
                'Authorization' : 'Bearer %s' % tvdb_token }
...
def get_series_season_image( series_id, airedSeason, tvdb_token, verify = True ):
    """
    Returns a :py:class:`tuple` of the TVDB_ URL of the TV show's SEASON poster AND the string "SUCCESS", if found. Otherwise returns an error :py:class:`tuple` given by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`. For example, here is the TVDB_ season poster URL for `The Simpsons, season 10`_.
    ...
    :returns: a :py:class:`tuple` of TV show SEASON poster URL, and the :py:class:`str` ``'SUCCESS'``. Otherwise an error tuple returned by :py:meth:`return_error_raw <plexstuff.plexcore.return_error_raw>`.
    :rtype: tuple

    .. seealso:: :py:meth:`get_series_image <plexstuff.plextvdb.plextvdb.get_series_image>`
...
def get_all_series_didend(
    ...
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
    :param int num_threads: the number of threads over which to parallelize this calculation. The default is *twice* the number of cores on the CPU.
    :param str tvdb_token: optional TVDB_ API access token. If ``None``, then gets the TVDB_ API access token with :py:meth:`get_token <plexstuff.plextvdb.get_token>`.
...
def get_remaining_episodes(
    ...
    * the remaining keys -- ``prefix``, ``showFilename``, ``min_inferred_length``, ``season_prefix_dict``, ``episode_number_length``, ``avg_length_mins`` -- and their values have the same meaning as the summary Plex_ TV library returned by :py:meth:`get_path_data_on_tvshow <plexstuff.plextvdb.plextvdb.get_path_data_on_tvshow>`.
...
def push_shows_to_exclude( tvdata, showsToExclude ):
    ...
    .. seealso:: :py:meth:`get_shows_to_exclude <plexstuff.plextvdb.plextvdb.get_shows_to_exclude>`
    """
...
def get_shows_to_exclude( tvdata = None ):
    ...
    :param dict tvdata: Optional Plex_ TV library information, returned by :py:meth:`get_library_data <plexstuff.plexcore.plexcore.get_library_data>`, to query. If not defined, then return the list of excluded TV shows found in the relevant table. If defined, returns an intersection of shows found in the table with TV shows in the Plex_ library.

    :returns: a :py:class:`list` of TV shows to ignore.
    :rtype: list

    .. seealso:: :py:meth:`push_shows_to_exclude <plexstuff.plextvdb.plextvdb.push_shows_to_exclude>`
    """
...
def create_tvTorUnits( toGet, restrictMaxSize = True, restrictMinSize = True,
    ...
    * The second element is a :py:class:`list` of new directories to create for missing episodes. In this example, there are new episodes for season 10 of `The Great British Bake Off`_, but no season 10 directory.
    ...
    :param dict toGet: a :py:class:`dict` of missing episodes by TV show on the Plex_ server, of the format returned by :py:meth:`get_remaining_episodes <plexstuff.plextvdb.plextvdb.get_remaining_episodes>`.
