...
def check_credentials( local_dir, sshpath, password, subdir = None ):
    ...
    .. seealso::
      * :py:meth:`push_credentials <plexstuff.plexcore.plexcore_rsync.push_credentials>`.
      * :py:meth:`get_credentials <plexstuff.plexcore.plexcore_rsync.get_credentials>`.
    """
    try:
        #
...
def push_credentials( local_dir, sshpath, password, subdir = None ):
    ...
    .. seealso::
      ...
      * :py:meth:`check_credentials <plexstuff.plexcore.plexcore_rsync.check_credentials>`.
      * :py:meth:`get_credentials <plexstuff.plexcore.plexcore_rsync.get_credentials>`.
    """
...
def get_rsync_command( data, mystr, do_download = True ):
    ...
    :param data: the :py:class:`dict` of rsync'ing configuration, described in :py:meth:`get_credentials <plexstuff.plexcore.plexcore_rsync.get_credentials>`.
