...
def send_email_lowlevel( msg, email_service = None, verify = True ):
    ...
    .. seealso:: :py:meth:`get_email_service <plexstuff.email.get_email_service>`.
...
class HowdyIMGClient( object ):
    ...
    * The value is a four element :py:class:`tuple`: image name, image ID, the URL link to this image, and the :py:class:`datetime <datetime.datetime>` at which the image was uploaded.
    ...
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
    :param dict data_imgurl: optional argument. If defined, must have the following keys: ``clientID``, ``clientSECRET``, and ``clientREFRESHTOKEN``. Must be consistent with :py:class:`dict` returned by :py:meth:`get_imgurl_credentials <plexstuff.plexcore.get_imgurl_credentials>`.
    ...
    .. seealso:: :py:meth:`refreshImages <plexstuff.plexemail.HowdyIMGClient.refreshImages>`
    ...
    def change_album_name( self, new_album_name ):
        ...
        .. seealso:: :py:meth:`refreshImages <plexstuff.email.HowdyIMGClient.refreshImages>`
        """
    ...
    def set_main_album( self, new_album_name ):
        ...
        * sets the new Imgur_ credentials using :py:meth:`store_imgur_credentials <plexstuff.plexcore.plexcore.store_imgurl_credentials>`.
    ...
    def get_candidate_album_names( self ):
        """
        :returns: a :py:class:`list` of album names in the Imgur_ account. :py:meth:`set_main_album <plexstuff.plexemail.PlexIMGClient.set_main_album>` can use this method to determine the valid album name to choose.

        .. seealso:: :py:meth:`get_candidate_albums <plexstuff.plexemail.PlexIMGClient.get_candidate_albums>`
        """
    ...
    def upload_image( self, b64img, name, imgMD5 = None ):
        ...
        .. seealso::
           ...
           * :py:meth:`refreshImages <plexstuff.email.HowdyIMGClient.refreshImages>`
           * :py:meth:`delete_image <plexstuff.email.HowdyIMGClient.delete_image>`
           * :py:meth:`change_name <plexstuff.email.HowdyIMGClient.change_name>`
    ...
    def delete_image( self, b64img, imgMD5 = None ):
        ...
        .. seealso::
           ...
           * :py:meth:`upload_image <plexstuff.email.HowdyIMGClient.upload_image>`
           * :py:meth:`change_name <plexstuff.email.HowdyIMGClient.change_name>`
        """
        if imgMD5 is None:
            imgMD5 = hashlib.md5( b64img ).hexdigest( )
...
class PNGPicObject( object ):
    """
    This provides a GUI widget to the Imgur_ interface implemented in :py:class:`PlexIMGClient <plexstuff.email.HowdyIMGClient>`. Initializaton of the image can either upload this image to the Imgur_ account, or retrieve the image from the main Imgur_ album. This object can also launch a GUI dialog window through :py:meth:`getInfoGUI <plexstuff.email.PNGPicObject.getInfoGUI>`.
    ...
    :param PlexIMGClient pImgClient: the :py:class:`PlexIMGClient <plexstuff.email.HowdyIMGClient>` used to access and manipulate (add, delete, rename) images in the main Imgur_ album.
    ...
    def createPNGPicObjects( cls, pImgClient ):
        """
        :param PlexIMGClient pImgClient: the :py:class:`PlexIMGClient <plexstuff.email.HowdyIMGClient>` used to access and manipulate (add, delete, rename) images in the main Imgur_ album.
        :returns: a :py:class:`list` of :py:class:`PNGPicObject <plexstuff.plexemail.PNGPicObject>` representing the images in the main Imgur_ album.
        :rtype: list
        """
        pngPICObjects = [ ]
    ...
    def changeName( self, new_name, hImgClient ):
        ...
        :param HowdyIMGClient hImgClient: the :py:class:`HowdyIMGClient <plexstuff.email.HowdyIMGClient>` used to access and manipulate (add, delete, rename) images in the main Imgur_ album.
        """
