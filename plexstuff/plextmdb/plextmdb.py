...
#
from plexstuff.plextmdb import get_tmdb_api, TMDBEngine, TMDBEngineSimple, tmdb_apiKey
from plexstuff.plexcore import return_error_raw
...
def get_episodes_series_tmdb( tv_id, verify = True ):
    ...
    .. seealso:: :py:meth:`get_tot_epdict_tmdb <plexstuff.plextvdb.plextvdb_attic.get_tot_epdict_tmdb>`
    """
...
def get_actor_ids_dict( actor_names, verify = True ):
    ...
    .. seealso:: :py:meth:`get_movies_by_actors <plexstuff.plextmdb.plextmdb.get_movies_by_actors>`
    """
    actor_name_dict = { }
...
def get_movies_by_actors( actor_name_dict, verify = True ):
    ...
    :param dict actor_name_dict: the :py:class:`dict`, of format returned by :py:meth:`get_actor_ids_dict <plexstuff.plextmdb.plextmdb.get_actor_ids_dict>`, of the collection of actors.
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
...
def get_movies_by_title( title, verify = True, apiKey = None ):
    ...
    .. seealso:: :py:meth:`get_movie_tmdbids <plexstuff.plextmdb.plextmdb.get_movie_tmdbids>`
    """
