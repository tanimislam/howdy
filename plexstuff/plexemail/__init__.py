...
class PlexIMGClient( object ):
    ...
    * The value is a four element :py:class:`tuple`: image name, image ID, the URL link to this image, and the :py:class:`datetime <datetime.datetime>` at which the image was uploaded.
    ...
    .. seealso:: :py:meth:`refreshImages <plexstuff.plexemail.PlexIMGClient.refreshImages>`
    ...
    def upload_image( self, b64img, name, imgMD5 = None ):
        ...
        .. seealso::
           ...
           * :py:meth:`refreshImages <plexstuff.plexemail.PlexIMGClient.refreshImages>`
           * :py:meth:`delete_image <plexstuff.plexemail.PlexIMGClient.delete_image>`
           * :py:meth:`change_name <plexstuff.plexemail.PlexIMGClient.change_name>`
    ...
    def delete_image( self, b64img, imgMD5 = None ):
        ...
        .. seealso::
           ...
           * :py:meth:`upload_image <plexstuff.plexemail.PlexIMGClient.upload_image>`
           * :py:meth:`change_name <plexstuff.plexemail.PlexIMGClient.change_name>`
        """
        if imgMD5 is None:
            imgMD5 = hashlib.md5( b64img ).hexdigest( )
...
class PNGPicObject( object ):
    """
    This provides a GUI widget to the Imgur_ interface implemented in :py:class:`PlexIMGClient <plexstuff.plexemail.PlexIMGClient>`. Initializaton of the image can either upload this image to the Imgur_ account, or retrieve the image from the main Imgur_ album. This object can also launch a GUI dialog window through :py:meth:`getInfoGUI <plexstuff.plexemail.PNGPicObject.getInfoGUI>`.
    ...
    :param PlexIMGClient pImgClient: the :py:class:`PlexIMGClient <plexstuff.plexemail.PlexIMGClient>` used to access and manipulate (add, delete, rename) images in the main Imgur_ album.
