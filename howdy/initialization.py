...
class HowdyInitialization( object ):
    """
    ...
    class __HowdyInitialization( object ):
        def __init__( self ):
            #
    ...
    def __new__( cls ):
        if not HowdyInitialization._instance:
            HowdyInitialization._instance = HowdyInitialization.__HowdyInitialization( )
        return HowdyInitialization._instance
