...
from plexstuff.plexcore import session
from plexstuff.plexcore import PlexConfig, LastNewsletterDate, PlexGuestEmailMapping
...
def get_all_servers( token, verify = True ):
    ...
    :param str token: the Plex :py:class:`str` access token, returned by :py:meth:`checkServerCredentials <plexstuff.plexcore.checkServerCredentials>`.
...
def get_current_date_newsletter( ):
    ...
    .. seealso:: :py:meth:`set_date_newsletter <plexstuff.plexcore.plexcore.set_date_newsletter>`
...
def get_library_stats( key, token, fullURL = 'http://localhost:32400', sinceDate = None ):
    ...
    * If the library is an ``artist`` (Music), then
    ...
    .. seealso:: :py:meth:`get_library_data <plexstuff.plexcore.plexcore.get_library_data>`
    """
...
def get_libraries( token, fullURL = 'http://localhost:32400', do_full = False, timeout = None ):
    ...
    .. seealso:
        ...
        * :py:meth:`fill_out_movies_stuff <plexstuff.plexcore.plexcore.fill_out_movies_stuff>`.
        * :py:meth:`get_movie_titles_by_year <plexstuff.plexcore.plexcore_attic.get_movie_titles_by_year>`.
        * :py:meth:`get_lastN_movies <plexstuff.plexcore.plexcore.get_lastN_movies>`.
        * :py:meth:`get_summary_data_music_remote <plexstuff.plexemail.plexemail.get_summary_data_music_remote>`.
        * :py:meth:`get_summary_data_television_remote <plexstuff.plexemail.plexemail.get_summary_data_television_remote>`.
        * :py:meth:`get_summary_data_movies_remote <plexstuff.plexemail.plexemail.get_summary_data_movies_remote>`.
...
def get_lastN_movies( lastN, token, fullURL = 'http://localhost:32400',
    ...
    .. seealso:
        ...
        * :py:meth:`get_summary_data_movies_remote <plexstuff.plexemail.plexemail.get_summary_data_movies_remote>`.
        * :py:meth:`get_summary_data_movies <plexstuff.plexemail.plexemail.get_summary_data_movies>`.
...
def oauthCheckGoogleCredentials( ):
    ...
    .. seealso::
          ...
          * :py:meth:`oauthCheckGoogleCredentials <plexstuff.plexcore.plexcore.oauthCheckGoogleCredentials>`.
          * :py:meth:`oauthGetGoogleCredentials <plexstuff.plexcore.plexcore.oauthGetGoogleCredentials>`.
          * :py:meth:`oauthGetOauth2ClientGoogleCredentials <plexstuff.plexcore.plexcore.oauthGetOauth2ClientGoogleCredentials>`.
          * :py:meth:`oauth_generate_google_permission_url <plexstuff.plexcore.plexcore.oauth_generate_google_permission_url>`.
          * :py:meth:`oauth_store_google_credentials <plexstuff.plexcore.plexcore.oauth_store_google_credentials>`.
...
def store_jackett_credentials( url, apikey, verify = True ):
    ...
    .. seealso::
      ...
      * :py:meth:`get_jackett_credentials <plexstuff.plexcore.plexcore.get_jackett_credentials>`.
      * :py:meth:`check_jackett_credentials <plexstuff.plexcore.plexcore.check_jackett_credentials>`.
    """
...
def get_jackett_credentials( ):
    ...
    .. seealso::
      ...
      * :py:meth:`check_jackett_credentials <plexstuff.plexcore.plexcore.check_jackett_credentials>`.
      * :py:meth:`store_jackett_credentials <plexstuff.plexcore.plexcore.store_jackett_credentials>`.
...
def get_imgurl_credentials( ):
    ...
    .. seealso::
      ...
      * :py:meth:`check_imgurl_credentials <plexstuff.plexcore.plexcore.check_imgurl_credentials>`.
      * :py:meth:`store_imgurl_credentials <plexstuff.plexcore.plexcore.store_imgurl_credentials>`.
...
def check_imgurl_credentials(
    ...
    .. seealso::
      ...
      * :py:meth:`get_imgurl_credentials <plexstuff.plexcore.plexcore.get_imgurl_credentials>`.
      * :py:meth:`store_imgurl_credentials <plexstuff.plexcore.plexcore.store_imgurl_credentials>`.
...
def set_date_newsletter( ):
    ...
    .. seealso:: :py:meth:`get_current_date_newsletter <plexstuff.plexcore.plexcore.get_current_date_newsletter>`
    """
    query = session.query( LastNewsletterDate )
    backthen = datetime.datetime.strptime( '1900-01-01', '%Y-%m-%d' ).date( )
    val = query.filter( LastNewsletterDate.date >= backthen ).first( )
