...
from plexstuff.plexcore import session, PlexConfig
...
class TMDBEngine( object ):
    ...
    .. seealso:: :py:class:`TMDBEngineSimple <plexstuff.plextmdb.TMDBEngineSimple>`
    """
    ...
    def __new__( cls, verify = True ):
        """
        Instantiates a single object of type :py:class:`TMDBEngine.__TMDBEngine <plexstuff.plextmdb.TMDBEngine.__TMDBEngine>` that contains TMDB_ API genre ID mappings, and that updates the GUI database to load all TTF fonts in the ``resources`` subdirectory.

        :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
        :returns: a single instance of :py:class:`TMDBEngine.__TMDBEngine <plexstuff.plextmdb.TMDBEngine.__TMDBEngine>`.
        :rtype: :py:class:`TMDBEngine.__TMDBEngine <plexstuff.plextmdb.TMDBEngine.__TMDBEngine>`
        """
...
class TMDBEngineSimple( object ):
    """
    The singleton class that, once called, initializes movie genre information from the TMDB_ database. This object can then be accessed to find TMDB_ database genre IDs from genres or vice-versa. Unlike :py:class:`TMDBEngine <plexstuff.plextmdb.TMDBEngine>`, this also does not contain the TMDB_ API key.

    .. seealso:: :py:class:`TMDBEngine <plexstuff.plextmdb.TMDBEngine>`
    """
    ...
    def __new__( cls, verify = True ):
        """
        Instantiates a single object of type :py:class:`TMDBEngineSimple.__TMDBEngine <plexstuff.plextmdb.TMDBEngineSimple.__TMDBEngine>` that contains TMDB_ API genre ID mappings.

        :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
        :returns: a single instance of :py:class:`TMDBEngineSimple.__TMDBEngine <plexstuff.plextmdb.TMDBEngineSimple.__TMDBEngine>`.
        :rtype: :py:class:`TMDBEngineSimple.__TMDBEngine <plexstuff.plextmdb.TMDBEngineSimple.__TMDBEngine>`
        """
