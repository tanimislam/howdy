...
from plexstuff.music import pygn, parse_youtube_date, format_youtube_date
...
def oauth_store_google_credentials( credentials ):
    ...
    .. seealso:: :py:meth:`oauth_get_google_credentials <plexstuff.music.music.oauth_get_google_credentials>`
...
def oauth_get_google_credentials( ):
    ...
    .. seealso:: :py:meth:`oauth_store_google_credentials <plexstuff.music.music.oauth_store_google_credentials>`
    """
    val = session.query( PlexConfig ).filter( PlexConfig.service == 'gmusic_mobileclient' ).first( )
...
def download_best_song( artist_name, song_name, youtube = None,
                        verify = True):
    """
    If successful, downloads the most likely YouTube_ clip into an M4A_ file, whose name is ``"artist_name"."song_name".m4a``. Uses the LastFM_ API functionality, through :py:class:`HowdyLastFM <plexstuff.music.music.HowdyLastFM>`, to get the music metadata.
...
class HowdyMusic( object ):
    """
    This object uses the Gracenote_ API to get information on songs, albums, and artists. Uses :py:meth:`HowdyMusic.get_gracenote_credentials <plexstuff.music.music.HowdyMusic.get_gracenote_credentials>` to get the Gracenote_ API configuration data.
