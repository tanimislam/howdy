...
from howdy.core import core, QDialogWithPrinting, get_popularity_color
...
class HowdyMovieMyGUI( QDialogWithPrinting ):
    ...
    def __init__( self, token, movie_data_rows, isIsolated = True, verify = True ):
        super( HowdyMovieMyGUI, self ).__init__( None, isIsolated = isIsolated )
    ...
    def fill_out_movies( self, movie_data_rows ):
        ...
        #
        decades_in_order_dict = HowdyMovieMyGUI.create_decades_in_order( movie_data_rows )
...
class MyMovieTableModel( QAbstractTableModel ):
    ...
    def filloutMyMovieData( self, myMovieData ):
        ...
        decades_in_order_dict = HowdyMovieMyGUI.create_decades_in_order( myMovieData )
