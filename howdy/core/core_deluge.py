...
def deluge_format_info( status, torrent_id ):
    ...
    :param dict status: the status :py:class:`dict` for a given torrent, generated from :py:meth:`deluge_get_torrents_info <howdy.core.core_deluge.deluge_get_torrents_info>`.
