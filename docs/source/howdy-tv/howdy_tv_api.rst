...
* Provides the SQLAlchemy_ ORM class on TV shows to exclude from analysis or update on the Plex_ server. This is the ``showstoexclude`` table and is in the :py:class:`ShowsToExclude <howdy.tv.ShowsToExclude>` class.
...
* Robust functionality that, with the :ref:`howdy.tv.tv_torrents module`, allows for the automatic download of episodes missing from the Plex_ TV library.

.. automodule:: howdy.tv.tv
   :members:

howdy.tv.tv_torrents module
----------------------------------------------
...
The seven methods that return the episode magnet links found by different torrent services -- :py:meth:`get_tv_torrent_eztv_io <howdy.tv.tv_torrents.get_tv_torrent_eztv_io>` (`EZTV.IO`_), :py:meth:`get_tv_torrent_zooqle <howdy.tv.tv_torrents.get_tv_torrent_zooqle>` (Zooqle_), :py:meth:`get_tv_torrent_rarbg <howdy.tv.tv_torrents.get_tv_torrent_rarbg>` (RARBG_), :py:meth:`get_tv_torrent_torrentz <howdy.tv.tv_torrents.get_tv_torrent_torrentz>` (Torrentz_), :py:meth:`get_tv_torrent_kickass <howdy.tv.tv_torrents.get_tv_torrent_kickass>` (KickassTorrents_), :py:meth:`get_tv_torrent_tpb <howdy.tv.tv_torrents.get_tv_torrent_tpb>` (`The Pirate Bay`_), and the unified torrent searcher :py:meth:`get_tv_torrent_jackett <howdy.tv.tv_torrents.get_tv_torrent_jackett>` (Jackett_ torrent search) -- produce a common two element :py:class:`tuple` output format.
...
* If unsuccesful, then returns an error :py:class:`tuple` of the form returned by :py:meth:`return_error_raw <howdy.core.return_error_raw>`.
