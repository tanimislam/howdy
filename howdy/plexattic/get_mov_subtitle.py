...
#
from howdy.core import subscene, core_deluge
from howdy.movie import movie_subtitles

def get_items_yts( name, maxnum = 10 ):
    assert( maxnum >= 5 )
    items = movie_subtitles.get_subtitles_yts( name )
...
def get_items_subscene( name, maxnum = 20, extra_strings = [ ] ):
    assert( maxnum >= 5 )
    subtitles_map = movie_subtitles.get_subtitles_subscene( name, extra_strings = extra_strings )
...
def get_items_opensubtitles( name, maxnum = 20, extra_strings = [ ] ):
    assert( maxnum >= 5 )
    subtitles_map = movie_subtitles.get_subtitles_opensubtitles( name, extra_strings = extra_strings )
    if subtitles_map is None: return None
