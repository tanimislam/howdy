...
#
from plexstuff.plexcore import session, create_all, PlexConfig, Base
...
def save_tvdb_api( username, apikey, userkey, verify = True ):
    ...
    .. seealso:: :py:meth:`check_tvdb_api <plexstuff.plextvdb.check_tvdb_api>`
    """
    #
...
def get_token( verify = True, data = None ):
    ...
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
    :param dict data: optional argument. If provided, must be a dictionary containing the TVDB_ API credentials as described in :py:meth:`get_tvdb_api( ) <plexstuff.plextvdb.plextvdb.get_tvdb_api>`. Otherwise, returns the dictionary returned by :py:meth:`get_tvdb_api( ) <plexstuff.plextvdb.plextvdb.get_tvdb_api>`.
