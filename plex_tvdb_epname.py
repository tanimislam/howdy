...
def main( ):
    ...
    if args.do_summary:
        ...
        epdicts = plextvdb.get_tot_epdict_tvdb( seriesName, verify = args.do_verify, showFuture = True )
        if epdicts is None:
        ...
        seriesName = args.series.strip( )
        token = plextvdb.get_token( verify = args.do_verify )
        series_id = plextvdb.get_series_id( seriesName, token, verify = args.do_verify )
