...
#
from howdy.movie import get_tmdb_api, TMDBEngine, TMDBEngineSimple, tmdb_apiKey
from howdy.core import return_error_raw
...
def get_movies_by_actors( actor_name_dict, verify = True ):
    ...
    :param dict actor_name_dict: the :py:class:`dict`, of format returned by :py:meth:`get_actor_ids_dict <howdy.movie.movie.get_actor_ids_dict>`, of the collection of actors.
    :param bool verify: optional argument, whether to verify SSL connections. Default is ``True``.
